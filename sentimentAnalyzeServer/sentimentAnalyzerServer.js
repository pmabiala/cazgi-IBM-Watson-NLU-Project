    ...
    //Extract the url passed from the client through the request object
     ...
     const analyzeParams = 
      ...
      .then(analysisResults => {
         ...
         console.log("analysisResults.result.keywords =>", analysisResults.result.keywords);
...
app.get("/text/emotion", (req,res) => {
    //Former static result return res.send({"happy":"10","sad":"90"});
...
app.get("/text/sentiment", (req,res) => {
    //Former static result returned return res.send("text sentiment for "+req.query.text);
    //Extract the url passed from the client through the request object
    let textToAnalyze = req.query.text
    const analyzeParams = 
        {
